            ...
            <div className="row">
                ...
                <div className="col-md-4 pt-5">
                    ...
                    <ul className="list-unstyled text-light footer-link-list">
                        ...
                        <li><a className="text-decoration-none" href="sport-wear">Sport Wear</a></li>
                        <li><a className="text-decoration-none" href="men-shoes">Men's Shoes</a></li>
                        <li><a className="text-decoration-none" href="women-shoes">Women's Shoes</a></li>
                        <li><a className="text-decoration-none" href="dress">Popular Dress</a></li>
                        <li><a className="text-decoration-none" href="gym">Gym Accessories</a></li>
                        <li><a className="text-decoration-none" href="sport-shoes">Sport Shoes</a></li>
                    </ul>
                </div>
                ...
                <div className="col-md-4 pt-5">
                    ...
                    <ul className="list-unstyled text-light footer-link-list">
                        ...
                        <li><a className="text-decoration-none" href="location">Shop Locations</a></li>
                        <li><a className="text-decoration-none" href="question">FAQs</a></li>
                ...
                <div className="col-auto me-auto">
                    <ul className="list-inline text-left footer-icons">
                        <li className="list-inline-item border border-light rounded-circle text-center">
                            <a className="text-light text-decoration-none" rel="noopener noreferrer" target="_blank" href="http://facebook.com/"><i className="fab fa-facebook-f fa-lg fa-fw"></i></a>
                        </li>
                        <li className="list-inline-item border border-light rounded-circle text-center">
                ...
                <div className="row pt-2">
                    <div className="col-12">
                        <p className="text-left text-light">
                            ...
                            | Designed by <a rel="noopener noreferrer" href="https://templatemo.com" target="_blank">TemplateMo</a>
                        </p>
                    </div>
                </div>
            </div>
